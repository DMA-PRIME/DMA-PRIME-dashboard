...
d3.csv("static/data/Counties daily cases/" + currentCounty + "_case_daily.csv").then(
    function (data) {

        d3.csv("static/data/RealDataCounties/" + currentCounty.toUpperCase() + "covid19.csv").then(function (real_data) {
